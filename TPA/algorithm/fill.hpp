...
#pragma region array
    /// <summary>
    /// Fills the std::array with the specified value upto the specified index
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="arr"></param>
    /// <param name="val"></param>
    ...
    inline constexpr void fill(std::array<T,SIZE>& arr, const T val, size_t item_count = 0)
    {
        try
        {
            //Prevent overflow
...
#pragma region vector
    /// <summary>
    /// <para>Fills the std::vector with the specified value upto the specified index</para>
    /// <para>Warning: This parallel implementation can be much, much slower than
    /// std::fill when accessing memory on the heap.</para>
    /// <para>This issue is exacerbated on systems with fewer memory channels, more channels is better.</para>
    /// <para>Not reccomended.</para>
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="arr"></param>
    /// <param name="val"></param>
    /// <param name="item_count"> - optional defaults to the size of the container</param>
    template<typename T>
    inline constexpr void fill(std::vector<T>& arr, const T val, size_t item_count = 0)
    {
        try
        {
            //Prevent overflow
