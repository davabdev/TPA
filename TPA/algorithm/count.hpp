...
#pragma region byte
                    if constexpr (std::is_same<T, int8_t>())
                    {
                        ...
                        if (tpa::hasAVX512_ByteWord && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm512_sum_epi8(_count));
                        }//End if
                        else if (tpa::hasAVX2 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm256_sum_epi8(_count));
                        ...
                        else if (tpa::has_SSE2 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm_sum_epi8(_count));
                        }//End if
#endif
                    }//End if
#pragma endregion
...
#pragma region short
                    if constexpr (std::is_same<T, int16_t>())
                    {
                        ...
                        if (tpa::hasAVX512_ByteWord && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm512_sum_epi16(_count));
                        }//End if
                        else if (tpa::hasAVX2 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm256_sum_epi16(_count));
                        ...
                        else if (tpa::has_SSE2 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm_sum_epi16(_count));
                        }//End if
#endif
                    }//End if
#pragma endregion
...
#pragma region int                    
                    if constexpr (std::is_same<T, int32_t>())
                    {
                        ...
                        if (tpa::hasAVX512 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm512_sum_epi32(_count));
                        }//End if
                        else if (tpa::hasAVX2 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm256_sum_epi32(_count));
                        ...
                        else if (tpa::has_SSE2 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm_sum_epi32(_count));
                        }//End if
#endif
                    }//End if
#pragma endregion
...
#pragma region long
                    if constexpr (std::is_same<T, int64_t>())
                    {
                        ...
                        if (tpa::hasAVX512 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm512_sum_epi64(_count));
                        }//End if
                        else if (tpa::hasAVX2 && useSIMD)
                        {
                        ...
                        else if (tpa::has_SSE41 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm_sum_epi64(_count));
                        }//End if
#endif
                    }//End if
#pragma endregion
...
#pragma region float
                    if constexpr (std::is_same<T, float>())
                    {
                        ...
                        if (tpa::hasAVX512 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm512_sum_ps(_count));
                        }//End if
                        else if (tpa::hasAVX2 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm256_sum_ps(_count));
                        ...
                        else if (tpa::has_SSE && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm_sum_ps(_count));
                        }//End if
#endif
                    }//End if
#pragma endregion
#pragma region double
                    if constexpr (std::is_same<T, double>())
                    {
                        ...
                        if (tpa::hasAVX512 && useSIMD)
                        {
                            ...
                            cnt = static_cast<RETURN_T>(tpa::util::_mm512_sum_pd(_count));
                        }//End if
                        else if (tpa::hasAVX && useSIMD)
                        {
                            ...
                            for (; (i + 4uz) < end; i += 4uz)
                            {
                                ...
                                _count = _mm256_sub_pd(_count, tpa::util::_mm256_cvtepi64_pd(_mask));
                            }//End for

                            cnt = static_cast<RETURN_T>(tpa::util::_mm256_sum_pd(_count));
                        ...
                        else if (tpa::has_SSE2 && useSIMD)
                        {
                            ...
                            for (; (i + 4uz) < end; i += 4uz)
                            {
                                ...
                                _count = _mm_sub_pd(_count, tpa::util::_mm_cvtepi64_pd(_mask));
                            }//End for

                            cnt = static_cast<RETURN_T>(tpa::util::_mm_sum_pd(_count));
                        }//End if
#endif
                    }//End if
#pragma endregion
